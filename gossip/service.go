...
import (
	...
	"github.com/frenchie-foundation/go-opera/gossip/blockproc/drivermodule"
	"github.com/frenchie-foundation/go-opera/gossip/blockproc/eventmodule"
	"github.com/frenchie-foundation/go-opera/gossip/blockproc/evmmodule"
	"github.com/frenchie-foundation/go-opera/gossip/blockproc/sealmodule"
	"github.com/frenchie-foundation/go-opera/gossip/blockproc/verwatcher"
	"github.com/frenchie-foundation/go-opera/gossip/emitter"
	"github.com/frenchie-foundation/go-opera/gossip/filters"
...
func (s *Service) Stop() error {
	defer log.Info("Frenchie service stopped")
	s.verWatcher.Stop()
	close(s.done)
	s.emitter.Stop()
	s.pm.Stop()
